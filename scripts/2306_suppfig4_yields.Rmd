...
(yieldplots.ang <- dftech.a %>% 
  ...
  theme(text = element_text(size = 15),
        legend.position = "none", panel.grid.major = element_line(color = "gray80"),
    panel.grid.minor = element_line(color = "gray80")) + scale_y_continuous(labels = function(x) sprintf("%.2f", x)) + 
...
(yieldplots.bod <- dftech.b %>% 
  ...
  theme(text = element_text(size = 15),
        legend.position = "none", panel.grid.major = element_line(color = "gray80"),
    panel.grid.minor = element_line(color = "gray80")) + scale_y_continuous(labels = function(x) sprintf("%.2f", x), limits = c(1, 4.75)) + 
...
#ggsave('TechnicalRepyields_withstats.png', together, dpi=300, width = 10, height = 6)
```
...
(yieldplots.bod.bio <- dfbio.b %>% 
  ...
  theme(text = element_text(size = 15),
        legend.position = "none", panel.grid.major = element_line(color = "gray80"),
    panel.grid.minor = element_line(color = "gray80")) + #scale_y_continuous(labels = function(x) sprintf("%.2f", x), limits = c(2.4, 14)) + 
...
(yieldplots.mgl.bio <- dfbio.m %>% 
  ...
  theme(text = element_text(size = 15),
        legend.position = "none", panel.grid.major = element_line(color = "gray80"),
    panel.grid.minor = element_line(color = "gray80")) + scale_y_continuous(labels = function(x) sprintf("%.2f", x), limits = c(.1, .6)) + 
  facet_wrap(~Site, labeller = labeller(Site = c("ML" = "Grassland")) ))
...
#ggsave('BiologicalRepyields_withstats.png', together.bio, dpi=300, width = 10, height = 6)
```


```{r}
(combinedyields <- plot_grid(together.bio, together.bio.reps, together, ncol = 1, labels = c('A','B','C')))
ggsave('DNAYields_Allsoils_allreps.png', combinedyields, width = 10, height = 10)
```
